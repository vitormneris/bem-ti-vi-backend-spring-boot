...
public interface CustomerRepository extends JpaRepository<CustomerEntity, String> {
    ...
    @Query(value = "SELECT new com.bemtivi.bemtivi.controllers.auth.dto.UserAuthDTO( c.id, c.name, c.email, c.role, c.password ) FROM CustomerEntity c WHERE c.email = ?1")
